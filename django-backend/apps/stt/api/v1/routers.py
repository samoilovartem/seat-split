...
from apps.stt.api.v1.seasons import SeasonViewSet
...
stt_router_v1.register(r'ticket-holders-teams', TicketHolderTeamViewSet, basename='ticket-holders-teams')
...
stt_router_v1.register(r'seasons', SeasonViewSet, basename='seasons')
