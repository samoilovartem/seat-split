...
STT_NOTIFICATIONS_EMOJI = {
    ...
    'TICKET_HOLDER_TEAM_CREATED': os.environ.get('TICKET_HOLDER_TEAM_CREATED', ':sparkle:'),
...
STT_NOTIFICATIONS_CHANNEL_TICKET_HOLDER_URL = f'{DJANGO_HOST_URL}/admin/stt/ticketholder'
...
STT_WEEKLY_ISSUES_REPORT_CHANNEL_ID = os.environ.get('STT_WEEKLY_ISSUES_REPORT_CHANNEL_ID')
