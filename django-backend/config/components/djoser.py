DJOSER = {
    ...
    'PERMISSIONS': {
        ...
        'user_create': ['apps.utils.permissions.CustomDjangoModelPermissions'],
        'user_delete': ['apps.utils.permissions.CustomDjangoModelPermissions'],
        'user': ['rest_framework.permissions.IsAuthenticated'],
        'user_list': ['apps.utils.permissions.CustomDjangoModelPermissions'],
        'token_create': ['rest_framework.permissions.IsAuthenticated'],
        'token_destroy': ['rest_framework.permissions.IsAuthenticated'],
    },
    'SERIALIZERS': {
        'current_user': 'apps.users.serializers.DjoserUserSerializer',
        'user': 'apps.users.serializers.DjoserUserSerializer',
