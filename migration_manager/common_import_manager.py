...
# ================================= READING CSV FILE ======================================
path_to_read = '/Users/samoylovartem/Documents/Data migration/New Accounts/Summary of Accounts Report to CSV - Pre-deployment.csv'
...
df['facebook_created'].replace(r'^\s*$', np.nan, regex=True, inplace=True)
df['twitter_created'].replace(r'^\s*$', np.nan, regex=True, inplace=True)
